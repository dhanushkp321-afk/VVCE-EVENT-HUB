...
function applyAttendanceRewards(eventId, userId, attended, ev) {
  ...
  // Also update user's points and pointsBySem so the dashboard boxes reflect correctly
